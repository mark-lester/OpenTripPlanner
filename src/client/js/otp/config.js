otp.config = {
    ...
    restService: "/srilanka/otp/routers/default",
...
//            subdomains : ['a','b','c'],
    ...
    siteName            : "WikiTimeTable Sri Lanka - Crowd Sourced Route Planner",
    ...
    geocoders : [
        ...
        'url': 'http://www.wikitimetable.com:8089/geocoder/geocode-test',
	'port':8089,
...
otp.config.GeoJson={};
otp.config.GeoJson.active='srilanka';
