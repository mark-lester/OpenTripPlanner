otp.config = {
    ...
    restService: "/thailand/otp/routers/default",
...
//            subdomains : ['a','b','c'],
    ...
    siteName            : "WikiTimeTable Thailand - Crowd Sourced Route Planner",
    ...
    geocoders : [
        ...
        'url': 'http://www.wikitimetable.com:8088/geocoder/geocode-test',
	'port':8088,
...
otp.config.GeoJson={};
otp.config.GeoJson.active='thailand';
